...
describe('PaymentItem Management Component', () => {
  let comp: PaymentItemComponent;
  let fixture: ComponentFixture<PaymentItemComponent>;
  let service: PaymentItemService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'payment-item', component: PaymentItemComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PaymentItemComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.paymentItems?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
