...
describe('CashRegister Management Component', () => {
  let comp: CashRegisterComponent;
  let fixture: ComponentFixture<CashRegisterComponent>;
  let service: CashRegisterService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'cash-register', component: CashRegisterComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(CashRegisterComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cashRegisters?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
