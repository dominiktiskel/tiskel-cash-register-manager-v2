...
describe('Invoice Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      created: currentDate,
      payedDate: currentDate,
      periodBeginDate: currentDate,
      ...
      const returnedFromService = Object.assign(
        {
          ...
          payedDate: currentDate.format(DATE_TIME_FORMAT),
          periodBeginDate: currentDate.format(DATE_TIME_FORMAT),
          periodEndDate: currentDate.format(DATE_TIME_FORMAT),
        },
        elemDefault
      );
