...
/**
 * REST controller for managing {@link com.tiskel.crm.domain.Receipt}.
 */
@RestController
@RequestMapping("/api")
public class ReceiptResource {
     ...
     */
    @GetMapping("/receipts")
    public ResponseEntity<List<ReceiptDTO>> getAllReceipts(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
